 ...
 */
#ifndef NETWORK_TORUS_MESHDIMORDERROUTINGALGORITHM_H_
#define NETWORK_TORUS_MESHDIMORDERROUTINGALGORITHM_H_
...
class MeshDimOrderRoutingAlgorithm : public RoutingAlgorithm {
 public:
  MeshDimOrderRoutingAlgorithm(
...
#endif  // NETWORK_TORUS_MESHDIMORDERROUTINGALGORITHM_H_
